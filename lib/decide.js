  ...
  if (type === "medical") {
    ...
    if (severity === "minor") {
      const firstAidTopics = [
        "minor_wound", "burn", "injury", "fever", "headache", "dizziness",
        ...
        "heat_exhaustion", "choking", "seizure", "spinal_injury", "confusion",
      ];
      ...
      const kitReady = firstAid && (
        ...
        topics.length > 1 ||
        (topics.includes("minor_wound") && (explicitMinorWound || unresolvedMissingInfo.length === 0))
      );
