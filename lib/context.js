...
function extractWoundLocation(text) {
  ...
  const patterns = [
    /\b(?:on|at|in|sa)\s+(?:my|the|aking)\s+(right|left)\s+(hand|arm|forearm|leg|foot|knee|head|face|finger|daliri|kamay|braso|binti|paa|tuhod|mukha)\b/i,
    /\b(?:on|at|in|sa)\s+(?:my|the|aking)\s+(hand|arm|forearm|leg|foot|knee|head|face|finger|daliri|kamay|braso|binti|paa|tuhod|mukha)\b/i,
    /\b(?:on|at|in|sa)\s+(?:my|the|aking)\s+(index|middle|ring|little|pinky|thumb)\s+(finger|daliri)\b/i,
    /\b(?:my|the|aking)\s+(right|left)\s+(hand|arm|forearm|leg|foot|knee|head|face|finger|daliri|kamay|braso|binti|paa|tuhod|mukha)\b/i,
    /\b(?:my|the|aking)\s+(index|middle|ring|little|pinky|thumb)\s+(finger|daliri)\b/i,
    /\b(?:cut|wound|hiwa|sugat)\s+(?:is\s+)?(?:on|at|in|sa)\s+(?:my|the|aking)\s+(right|left)\s+(hand|arm|forearm|leg|foot|knee|head|face|finger|daliri|kamay|braso|binti|paa|tuhod|mukha)\b/i,
    /\b(?:cut|wound|hiwa|sugat)\s+(?:is\s+)?(?:on|at|in|sa)\s+(?:my|the|aking)\s+(index|middle|ring|little|pinky|thumb)\s+(finger|daliri)\b/i,
    /\b(?:cut|wound|hiwa|sugat)\s+(?:my|the|aking)?\s*(finger|hand|arm|forearm|leg|foot|knee|head|face|daliri|kamay|braso|binti|paa|tuhod|mukha)\b/i,
    /\bI\s+(?:cut|hurt)\s+(?:my|the)?\s*(finger|hand|arm|forearm|leg|foot|knee|head|face|daliri|kamay|braso|binti|paa|tuhod|mukha)\b/i,
    /^(finger|hand|arm|forearm|leg|foot|knee|head|face|daliri|kamay|braso|binti|paa|tuhod|mukha)$/i,
  ];
