...
const KIT = [
  ...
  { id: 'elastic-bandage', name: 'Elastic Bandage (ACE Type)', category: 'Injury Support & Immobilization', uses: ['localized compression and structural support for minor strains and sprains'], topics: ['injury', 'sprain'], minSeverity: 'minor' },
  { id: 'triangular-bandage', name: 'Triangular Bandage', category: 'Injury Support & Immobilization', uses: ['constructing slings, securing splints, or binding extremity injuries'], topics: ['injury', 'sprain'], minSeverity: 'minor' },
  { id: 'instant-cold-pack', name: 'Instant Cold Packs / Compresses', category: 'Injury Support & Immobilization', uses: ['localized cryotherapy to reduce swelling, inflammation, and pain from minor bumps or sprains'], topics: ['injury', 'sprain'], minSeverity: 'minor' },
